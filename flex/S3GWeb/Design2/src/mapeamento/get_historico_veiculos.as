package mapeamento
{
    [RemoteClass(alias="S3GWeb_get_historico.get_historico_veiculo")]
	public class get_historico_veiculos
	{
		public static const NAMESPACE:String = "S3GWeb_get_historico.get_historico_veiculo";
		...
		private var _datahorarecebimento:String;
		public function get datahorarecebimento():String{ return this._datahorarecebimento; }                
	    public function set datahorarecebimento(valor:String):void { this._datahorarecebimento = valor; }	
		...
		public function get_historico_veiculos()
		{
		}
