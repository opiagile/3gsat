package mapeamento
{
	...
	public class get_veiculos_por_cliente
	{
		...
		public function get altitude():int { return this._altitude; }                
		public function set altitude(valor:int):void { this._altitude = valor; }	

		private var _direcao:int;
		public function get direcao():int { return this._direcao; }                
		public function set direcao(valor:int):void { this._direcao = valor; }	

		private var _status_gprs_gps:int;
		public function get status_gprs_gps():int { return this._status_gprs_gps; }                
		public function set status_gprs_gps(valor:int):void { this._status_gprs_gps = valor; }	

		private var _estadobateria:int;
		public function get estadobateria():int { return this._estadobateria; }                
		public function set estadobateria(valor:int):void { this._estadobateria = valor; }	

		private var _qtdesatelite:int;
		public function get qtdesatelite():int { return this._qtdesatelite; }                
		public function set qtdesatelite(valor:int):void { this._qtdesatelite = valor; }	

		private var _alimentacaobateria:int;
		public function get alimentacaobateria():int { return this._alimentacaobateria; }                
		public function set alimentacaobateria(valor:int):void { this._alimentacaobateria = valor; }	
